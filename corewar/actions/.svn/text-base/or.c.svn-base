/*
** or.c for or in /home/dell-a_f/corewar-2016-knocka_a/virtual_m/actions
** 
** Made by florian dell'aiera
** Login   <dell-a_f@epitech.net>
** 
** Started on  Sat Mar 24 11:21:34 2012 florian dell'aiera
** Last update Sat Mar 24 17:28:00 2012 florian dell'aiera
*/

#include	"../vm.h"

void		type_register_or(t_glob *glob, t_champ *champ, int *args, int *type)
{
  int		fst_r;
  int		fst_indirect;
...
void		type_direct_or(t_glob *glob, t_champ *champ, int *args, int *type)
{
  int		fst_direct;
  int		second_indirect;
...
void		type_indirect_or(t_glob *glob, t_champ *champ, int *args, int *type)
{
  int		fst_indirect;
  int		second_indirect;
  ...
  if (champ != NULL)
    {
      ...
      if (type[0] == 1)
	type_register_or(glob, champ, args, type);
      if (type[0] == 2)
	type_direct_or(glob, champ, args, type);
      if (type[0] == 3)
	type_indirect_or(glob, champ, args, type);
      champ->carry = '1';
    }
}
